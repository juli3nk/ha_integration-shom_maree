"""ShomMareeAPI class for interacting with the SHOM (Service Hydrographique et Océanographique de la Marine) API.

It retrieves tide data such as high and low tides, including times, heights, and coefficients for a specific harbor over a given duration.
